...
int main(){
     ...
     Planet Mercury("Mercury",1.651E-7, 0.241, mercuryPosition);
     Planet Venus("Venus",0.000002447,0.63, venusPosition);
     Planet Mars("Mars",3.213E-7,1.9, marsPosition);
     Planet Jupiter("Jupiter", 0.0009543,11.9, jupiterPosition);
     Planet Saturn("Saturn",0.0002857,29.5, saturnPosition);
     Planet Uranus("Uranus",0.00004365 ,84.1, uranusPosition);
     Planet Neptune("Neptune",0.00005149, 164.7, neptunePosition);
